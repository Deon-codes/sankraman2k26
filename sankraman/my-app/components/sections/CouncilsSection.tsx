...
export default function CouncilsSection() {
  const councils = [
    ...
    { name: "PROJECT CELL", fullName: "Innovation Hub", description: "Transforming ideas into technological reality" },
    { name: "IEEE", fullName: "Institute of Electrical & Electronics Engineers", description: "Advancing technology for humanity" }
  ];
